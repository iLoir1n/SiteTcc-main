...
<head>
    ...
    <style>
        .test-container form{
            box-shadow: 0 0.0625rem 0.3125rem rgb(0 0 0 / 40%);
            /*cria um sombreamento nas bordas*/
            margin: 100px;
            padding: 40px;
            background-color: rgb(231, 246, 247);
            border-radius: 15px;
            /*arredondar todas as bordas*/
        }
            ...
            <nav class="navbar navbar-expand-lg fixed-top navbar-dark">
                ...
                <div class="collapse navbar-collapse justify-content-end nav-pills " id="navbar-links">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-item nav-link" id="about-menu" href="toxidade.php">O que é toxidade</a>
        ...
        <footer>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4 contact-box">
                            ...
                            <p><span class="contact-tile">Discord: </span><a id="text-sem-decoracao"
                                    href="https://discord.gg/h56UMNrs">Clique Aqui</a></p>
                        </div>
                        <div class="col-md-4 contact-box">
            ...
            <div id="copy-area">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <p>Desenvolvido por <a href="#" target="_blank">JL Community</a> &copy; 2021</p>
                        </div>
                    </div>
                </div>
            </div>
